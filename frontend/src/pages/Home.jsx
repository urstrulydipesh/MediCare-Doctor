          ...
          <div className='flex flex-col lg:flex-row gap-[90px] items-center justify-between'>
            ...
            <div>
              <div className='lg:w-[570px]'>
                ...
                Your body deserves the best. <p>
                  book a doctor easily ! 
                  </p> 
                </h1>
                <p className='text__para'>
                "Finding doctors online at any time offers unmatched convenience, instant access, 
                and a broader range of medical expertise. It saves valuable time, eliminates the 
                need for travel, and ensures timely consultations, accurate diagnoses, and effective 
                treatments. This 24/7 accessibility empowers individuals to take control of their health, 
                prioritize their well-being, and connect with trusted healthcare professionals with ease 
                and confidence."
                </p>
            ...
            <div className='relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0'>
              ...
              <div className='flex items-center gap-[6px] lg:gap-[10px] mt-2 lg:mt-[18px]'>
                ...
                <h4 className='text-[10px] leading-3 lg:text-[16px] lg:leading-[22px] font-[700]
                 text-headingColor'>Dipesh Shah</h4>
              </div>
